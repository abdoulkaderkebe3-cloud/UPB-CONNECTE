        ...
        <div className="bg-[#0F172A] text-white p-5 mx-auto   rounded-2xl shadow-lg w-full max-w-md">
          <div className='flex justify-between'>
              <div className="flex  items-center mb-4">
                ...
                <span className="bg-gray-700 px-2 py-1 rounded-[10px] text-[10px] ml-2">{typeCours}</span>
              </div>
          ...
          <h2 className="text-xl font-bold mb-1 inter ">{classe}•{titreCours}</h2>
          <p className="text-gray-400 text-sm mb-6">{room} • {studentCount} Étudiants</p>
          ...
          <div className="space-y-3">
            ...
            <button className="w-full py-3 rounded-xl bg-[#FF9500BF] text-white cursor-pointer inter  font-bold hover:bg-orange-600 transition active:translate-1">
              Valider ma présence
            </button>
          </div>
        </div>
